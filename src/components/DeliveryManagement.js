...
const DeliveryManagement = () => {
  ...
  const [showCustomerModal, setShowCustomerModal] = useState(false); // Nuevo estado para modal de cliente
  const [selectedCustomer, setSelectedCustomer] = useState(null); // Cliente seleccionado para el formulario de delivery
...
const CustomerSelectionModal = ({ customers, onSelectCustomer, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl max-w-md w-full max-h-screen overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-900">Seleccionar Cliente</h2>
            <button
              onClick={onClose}
              className="text-gray-400 hover:text-gray-600"
            >
